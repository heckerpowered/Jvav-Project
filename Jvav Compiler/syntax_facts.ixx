...
namespace compiler
{
	...
	public:
		...
		static std::uint_fast8_t get_unary_operator_precedence(const syntax_kind kind) noexcept
		{
			switch (kind)
			{
		...
		static std::uint_fast8_t get_binary_operator_precedence(const syntax_kind kind) noexcept
		{
			switch (kind)
			{
